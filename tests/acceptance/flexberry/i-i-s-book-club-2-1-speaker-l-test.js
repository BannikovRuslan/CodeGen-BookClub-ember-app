...
moduleForAcceptance('[AGAT] Acceptance | i i s book club 2 1 speaker l');

test('testing i-i-s-book-club-2-1-speaker-l', function(assert) {
  visit('/i-i-s-book-club-2-1-speaker-l');
