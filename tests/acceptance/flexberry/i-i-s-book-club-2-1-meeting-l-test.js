...
moduleForAcceptance('[AGAT] Acceptance | i i s book club 2 1 meeting l');

test('testing i-i-s-book-club-2-1-meeting-l', function(assert) {
  visit('/i-i-s-book-club-2-1-meeting-l');
